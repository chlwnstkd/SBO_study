...
public class UserInfoController {
    ...
    public UserInfoDTO searchEmail(HttpServletRequest request) throws Exception {
        ...
        // 입력된 이메일이 중복된 이메일인지 조회
        UserInfoDTO rDTO = Optional.ofNullable(userInfoService.searchEmail(pDTO)).orElseGet(UserInfoDTO::new);
